...
Usage:
    from thorin.backends import best_backend, detect, summary
...
from thorin.backends.x86 import detect_x86_capabilities, x86_kernels_available
from thorin.backends.arm import detect_arm_capabilities, neon_kernels_available
from thorin.backends.wasm import is_wasm_available, wasm_simd_available
