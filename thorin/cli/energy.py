#!/usr/bin/env python3
"""THORIN energy — energy consumption profiling.

Usage:
    thor energy <model> [--mode <MODE>] [--runs <N>]

Measures energy usage per inference run using the THORIN runtime's built-in
...
def register_subparser(subparsers: argparse._SubParsersAction) -> None:
    p = subparsers.add_parser(
        ...
        description=(
            ...
            "Reads THORIN runtime energy counters plus optional RAPL powercap "
