...
def _convert_pytorch(src: str, dst: str, quantize: str | None) -> None:
    try:
        from thorin.importer import convert_pytorch_model
...
def _convert_onnx(src: str, dst: str, quantize: str | None) -> None:
    try:
        from thorin.importer import convert_onnx_model
    except ImportError as e:
        print(
...
def _convert_gguf(src: str, dst: str, quantize: str | None) -> None:
    ...
    try:
        from thorin.importer.gguf import convert_gguf_model as gguf_convert
    except ImportError as e:
        print(
