...
RIN_DEFAULT_CONFIG: Dict[str, Any] = {
    "mode": "mlp",
    "temperature": 0.8,
    "top_k": 40,
    "top_p": 0.9,
...
_ENV_KEYS: Dict[str, str] = {
    "RIN_MODE": "mode",
    "RIN_TEMPERATURE": "temperature",
    "RIN_TOP_K": "top_k",
    "RIN_TOP_P": "top_p",
    "RIN_POWER_BUDGET": "power_budget",
}


def get_config(key: str, default: Any = None) -> Any:
    return RIN_DEFAULT_CONFIG.get(key, default)


def merge_config(overrides: Dict[str, Any]) -> Dict[str, Any]:
    cfg = dict(RIN_DEFAULT_CONFIG)
